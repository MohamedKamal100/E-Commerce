  ...
  return (
    <>
      <div className="container mx-auto">
        <h2 className="text-4xl mt-10 font-extrabold px-6 py-2 bg-gradient-to-r from-green-500 via-white to-green-500 text-gray-900 shadow-md tracking-wide rounded-lg">
          Product Details
        </h2>
        ...
        {relatedProducts.length > 0 && (
          <>
            <h2 className="text-3xl font-bold mt-10 mb-4 text-green-700">Related Products</h2>
            <div className="gap-y-2 grid grid-cols-2 md:grid-cols-4 gap-4">
